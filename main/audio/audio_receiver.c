...
// "AirPlay 即将占用 I2S" 回调。由 main.c 注册为 web_radio_yield_to_airplay,
// 让正在播的 web radio 主动让出 I2S。见 audio_receiver.h 的说明。
static audio_receiver_yield_cb_t s_yield_cb = NULL;
